<template>
    <div>
        <el-card class="box-card" style="width: 32vw;height: 25vw;margin: 0 auto;margin-top: 10vw">
            ...
            <el-form :model="user" label-position="right" label-width="auto" style="width: 24vw;margin: 0 auto"
                ...
                <el-form-item prop="userGender">
                    ...
                    <el-select v-model="user.userGender" placeholder="请选择性别" style="width: 20.45vw;">
                ...
                <el-form-item>
                    ...
                    <el-date-picker type="date" placeholder="请选择生日" v-model="user.userBirth"
                                    :picker-options="pickerOptions" style="width: 20.45vw;"
